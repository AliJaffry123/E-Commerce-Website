...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['name'])) {
       ...
       $sql = "INSERT INTO projtest.review (name, email, other) VALUES ('$name','$email','$msg');";
            // $ser++;
            // echo $sql . "<br>";
...
<div class="container-fluid" style="padding: 0px">
    ...
    <div class="row" style="display: flex;">
        <div class="col-md-4" style="padding: 0px">
            <a href="blackshirt.php"> <img src="men/blackshirt1.avif" style="width: -webkit-fill-available"></a>
        </div>
        <div class="col-md-4" style="padding: 0px">
         <a href="jacket.php"> <img src="men/jacket1.avif" style="width: -webkit-fill-available"></a>
     </div>
     <div class="col-md-4" style="padding: 0px">
         <a href="turtleneck.php"> <img src="men/turtleneck1.avif" style="width: -webkit-fill-available"></a>
     </div>
 </div>
 <h2><b>WOMEN</b></h2>
 <div class="row" style="display: flex;">
    <div class="col-md-4" style="padding: 0px">
        <a href="flaredskirt.php"><img src="women/flaredskirt1.avif" style="width: -webkit-fill-available"></a>
    </div>
    <div class="col-md-4" style="padding: 0px">
        <a href="coat.php"><img src="women/coat1.avif" style="width: -webkit-fill-available"></a>
    </div>
    <div class="col-md-4" style="padding: 0px">
     <a href="weave.php"> <img src="women/weave1.avif" style="width: -webkit-fill-available"></a>
 </div>
</div>
</div>
...
<div class="container-fluid last">
    <div class="row bottom">
      ...
      <br>
      <img src="images/sakinah.png" style="width: 274px; height: 111px">
  ...
  <div class="col-md-3" style=" width: 23%;">
    <div class="container lining" style="display: flex;">
      <h4 style="margin-left: 0px; margin-bottom: 0px; border-bottom: 2px solid #cf0505; width: 41%; padding: 0px 0px 10px 0px; font-size: 15px; font-weight: 700;">PRODUCT INFO</h4><h4 class="line2">.</h4>
      <!-- <hr style="margin-left: 0px; width: 12%; border-top: 3px solid #cf0505; margin-bottom: 0px;"> <hr style="margin-left: 389px; margin-top: 0px; border-top: 1px solid #977f7f; width: 60%"> -->
  </div>
  <br>
...
<div class="col-md-3" style=" width: 23%;">
    <div class="container lining" style="display: flex;">
      <h4 style="margin-left: 0px; margin-bottom: 0px; border-bottom: 2px solid #cf0505; width: 50%; padding: 0px 0px 10px 0px; font-size: 15px; font-weight: 700;">SUPPORT CENTER</h4><h4 class="line3">.</h4>
      <!-- <hr style="margin-left: 0px; width: 12%; border-top: 3px solid #cf0505; margin-bottom: 0px;"> <hr style="margin-left: 389px; margin-top: 0px; border-top: 1px solid #977f7f; width: 60%"> -->
  </div>
  <br>
...
<div class="col-md-3" style=" width: 23%;">
    <div class="container lining" style="display: flex;">
      <h4 style="margin-left: 0px; margin-bottom: 0px; border-bottom: 2px solid #cf0505; width: 45%; padding: 0px 0px 10px 0px; font-size: 15px; font-weight: 700;">QUICK CONTACT</h4><h4 class="line4">.</h4>
      <!-- <hr style="margin-left: 0px; width: 12%; border-top: 3px solid #cf0505; margin-bottom: 0px;"> <hr style="margin-left: 389px; margin-top: 0px; border-top: 1px solid #977f7f; width: 60%"> -->
  </div>
  <br>
  <?php
