...
<div class="container-fluid" style="display: flex; padding: 0px; margin-top: 35px">
    ...
    <div class="row" style="width:">
        <a href="w_accessories.php"><button class="accessories" style="background-color: transparent; border: 1px solid black; color: black; font-size: 15px;">ACCESSORIES</button></a>
    </div>
</div>
